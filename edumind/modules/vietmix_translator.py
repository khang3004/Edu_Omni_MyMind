...
_VIETNAMESE_COMMON_WORDS: set[str] = {
    "tôi", "mình", "tớ", "ta", "chúng", "các", "bạn", "anh", "chị", "em", "ông", "bà", "cô", "chú", "họ", "nó",
    "là", "có", "được", "và", "của", "cho", "với", "trong", "từ", "để", "này", "đỏ", "đó", "kia", "ấy", "nào",
    "gì", "sao", "nên", "vì", "nhưng", "nếu", "thì", "mà", "hay", "hoặc", "cũng", "đã", "đang", "sẽ", "rồi",
    "chưa", "không", "chẳng", "rất", "lắm", "quá", "hơn", "làm", "đi", "đến", "về", "biết", "hiểu", "nói",
    "xem", "học", "viết", "đọc", "nghe", "thấy", "cần", "muốn", "phải", "dùng", "bài", "môn", "lớp", "điểm",
    "thi", "hôm", "nay", "tuần", "tháng", "năm", "giờ", "phút", "nhớ", "ôn", "tập", "nộp", "trước", "sau",
...
_ENGLISH_COMMON_WORDS: set[str] = {
    "the", "a", "an", "and", "of", "to", "in", "is", "you", "that", "it", "he", "was",
    ...
    "who", "oil", "its", "now", "find", "input", "output", "dataset", "system", "model"
}
...
def _is_vietnamese_syllable(word: str) -> bool:
    ...
    invalid_starts = [
        ...
        "pl", "pr", "sc", "sk", "sl", "sm", "sn", "sp", "st", "str", "sw", "tw"
    ]
    ...
    if len(clean) > 1:
        ...
        invalid_end_clusters = [
            "ct", "nd", "nt", "mp", "rt", "st", "ld", "lf", "lk", "lp", "lt",
            "mb", "pt", "ft", "th", "rd", "rk", "rn", "ss", "sh"
        ]
